...
import { ErrorResponse, GraphEndProbeMessage, GraphStartProbeMessage, InputResponse, InputValues, NodeDescriptor, NodeEndProbeMessage, NodeStartProbeMessage, OutputResponse, OutputValues, RunState, SkipProbeMessage } from "../types.js";
/**
...
export type AnyProxyResponseMessage = ProxyResponseMessage | ErrorResponseMessage | ProxyChunkResponseMessage | EndResponseMessage;
export type AnyRunRequestMessage = RunRequestMessage | InputResolveRequestMessage;
export type AnyProbeMessage = RemoteMessage<NodeStartProbeMessage> | RemoteMessage<NodeEndProbeMessage> | RemoteMessage<GraphStartProbeMessage> | RemoteMessage<GraphEndProbeMessage> | RemoteMessage<SkipProbeMessage>;
export type AnyRunResponseMessage = OutputResponseMessage | InputResponseMessage | EndResponseMessage | ErrorResponseMessage | AnyProbeMessage;
