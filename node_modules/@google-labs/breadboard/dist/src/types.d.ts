 ...
 */
context: NodeHandlerContext) => Promise<OutputValues | void>;
/**
 ...
 */
export type NodeHandlers = ReservedNodeNames & Record<NodeTypeIdentifier, NodeHandler>;
...
export interface NodeFactory {
    create<Inputs, Outputs>(kit: Kit | undefined, type: NodeTypeIdentifier, configuration?: NodeConfigurationConstructor, id?: string): BreadboardNode<Inputs, Outputs>;
    getConfigWithLambda<Inputs, Outputs>(config: ConfigOrLambda<Inputs, Outputs>): OptionalIdConfiguration;
}
export interface KitConstructor<T extends Kit> {
    new (nodeFactory: NodeFactory): T;
}
export type NodeSugar<In, Out> = (config?: ConfigOrLambda<In, Out>) => BreadboardNode<In, Out>;
...
export type ProbeMessage = GraphStartProbeMessage | GraphEndProbeMessage | SkipProbeMessage | NodeStartProbeMessage | NodeEndProbeMessage;
/**
...
export interface RunnerLike {
    run(context?: NodeHandlerContext, result?: BreadboardRunResult): AsyncGenerator<BreadboardRunResult>;
 ...
 */
export type NodeConfigurationConstructor = Record<string, NodeValue | BreadboardNode<InputValues, OutputValues>>;
/**
 ...
 */
export type ConfigOrLambda<In, Out> = OptionalIdConfiguration | BreadboardCapability | BreadboardNode<LambdaNodeInputs, LambdaNodeOutputs> | GraphDescriptor | LambdaFunction<In, Out> | {
    board: BreadboardCapability | BreadboardNode<LambdaNodeInputs, LambdaNodeOutputs> | LambdaFunction<In, Out>;
};
export type LambdaFunction<In = InputValues, Out = OutputValues> = (board: Breadboard, input: BreadboardNode<In, Out>, output: BreadboardNode<In, Out>) => void;
