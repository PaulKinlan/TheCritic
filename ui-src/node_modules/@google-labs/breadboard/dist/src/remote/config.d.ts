...
export type TunnelSpec = {
    [outputName: string]: TunnelDestinations | TunnelDestinations[] | string[] | string;
};
...
export declare const defineConfig: (config: ProxyServerConfig) => ProxyServerConfig;
export declare const hasOrigin: (origin: string) => {
